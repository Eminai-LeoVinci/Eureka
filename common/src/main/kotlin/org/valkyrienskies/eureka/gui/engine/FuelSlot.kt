...
class FuelSlot(container: Container, slot: Int, x: Int, y: Int, private val fuelValues: FuelValues) :
    Slot(container, slot, x, y) {
    override fun mayPlace(stack: ItemStack): Boolean {
        return FuelRegistry.INSTANCE.get(stack, fuelValues) > 0 || isBucket(stack)
    }
